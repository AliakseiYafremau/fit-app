...
int _exerciseModelEstimateSize(
  ...
  bytesCount += 3 + object.musclesIds.length * 3;
  {
    for (var i = 0; i < object.musclesIds.length; i++) {
      final value = object.musclesIds[i];
      bytesCount += value.length * 3;
    }
  }
...
void _exerciseModelSerialize(
  ...
  writer.writeStringList(offsets[0], object.categoryIds);
  writer.writeString(offsets[1], object.entityId);
  writer.writeStringList(offsets[2], object.links);
  writer.writeStringList(offsets[3], object.musclesIds);
  writer.writeString(offsets[4], object.name);
  writer.writeString(offsets[5], object.notes);
  writer.writeString(offsets[6], object.photoId);
  writer.writeString(offsets[7], object.technique);
  writer.writeBool(offsets[8], object.usesWeights);
}
...
ExerciseModel _exerciseModelDeserialize(
  ...
  object.categoryIds = reader.readStringList(offsets[0]) ?? [];
  object.entityId = reader.readString(offsets[1]);
  object.isarId = id;
  object.links = reader.readStringList(offsets[2]) ?? [];
  object.musclesIds = reader.readStringList(offsets[3]) ?? [];
  object.name = reader.readString(offsets[4]);
  object.notes = reader.readString(offsets[5]);
  object.photoId = reader.readStringOrNull(offsets[6]);
  object.technique = reader.readString(offsets[7]);
  object.usesWeights = reader.readBool(offsets[8]);
  return object;
}
...
extension ExerciseModelQueryFilter
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QAfterFilterCondition>
      musclesIdsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'musclesIds',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QAfterFilterCondition>
      musclesIdsElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'musclesIds',
        value: value,
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QAfterFilterCondition>
      musclesIdsElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'musclesIds',
        wildcard: pattern,
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QAfterFilterCondition>
      musclesIdsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'musclesIds',
        length,
...
extension ExerciseModelQuerySortBy
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QAfterSortBy> sortByPhotoId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photoId', Sort.asc);
    });
  }

  QueryBuilder<ExerciseModel, ExerciseModel, QAfterSortBy> sortByPhotoIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExerciseModelQuerySortThenBy
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QAfterSortBy> thenByPhotoId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photoId', Sort.asc);
    });
  }

  QueryBuilder<ExerciseModel, ExerciseModel, QAfterSortBy> thenByPhotoIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photoId', Sort.desc);
    });
  }
...
extension ExerciseModelQueryWhereDistinct
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QDistinct> distinctByMusclesIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'musclesIds');
    });
  }
  ...
  QueryBuilder<ExerciseModel, ExerciseModel, QDistinct> distinctByPhotoId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExerciseModelQueryProperty
  ...
  QueryBuilder<ExerciseModel, List<String>, QQueryOperations>
      musclesIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'musclesIds');
    });
  }
  ...
  QueryBuilder<ExerciseModel, String?, QQueryOperations> photoIdProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelByIndex on IsarCollection<CategoryModel> {
  Future<CategoryModel?> getByEntityId(String entityId) {
    return getByIndex(r'entityId', [entityId]);
  }

  CategoryModel? getByEntityIdSync(String entityId) {
    return getByIndexSync(r'entityId', [entityId]);
  }
  ...
  Future<List<CategoryModel?>> getAllByEntityId(List<String> entityIdValues) {
    final values = entityIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'entityId', values);
  }

  List<CategoryModel?> getAllByEntityIdSync(List<String> entityIdValues) {
    final values = entityIdValues.map((e) => [e]).toList();
    return getAllByIndexSync(r'entityId', values);
  }
  ...
  Future<Id> putByEntityId(CategoryModel object) {
    return putByIndex(r'entityId', object);
  }

  Id putByEntityIdSync(CategoryModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'entityId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByEntityId(List<CategoryModel> objects) {
    return putAllByIndex(r'entityId', objects);
  }

  List<Id> putAllByEntityIdSync(List<CategoryModel> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'entityId', objects, saveLinks: saveLinks);
  }
}
...
extension CategoryModelQueryWhere
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> entityIdEqualTo(
      String entityId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'entityId',
...
extension CategoryModelQuerySortBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> sortByEntityId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entityId', Sort.asc);
    });
  }
...
extension CategoryModelQuerySortThenBy
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterSortBy> thenByEntityId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entityId', Sort.asc);
    });
  }
...
extension CategoryModelQueryWhereDistinct
  ...
  QueryBuilder<CategoryModel, CategoryModel, QDistinct> distinctByEntityId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'entityId', caseSensitive: caseSensitive);
    });
...
extension CategoryModelQueryProperty
  ...
  QueryBuilder<CategoryModel, String, QQueryOperations> entityIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'entityId');
    });
  }
