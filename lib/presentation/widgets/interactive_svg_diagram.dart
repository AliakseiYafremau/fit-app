...
const List<_MuscleRegion> _muscleRegions = <_MuscleRegion>[
  ...
  _MuscleRegion(
    ...
    label: 'Shoulders',
    shapes: <_RegionShape>[
      _RegionShape(alignment: Alignment(-0.36, -0.365), rotationDegrees: 0,
      points: <Offset>[
        Offset(0, 0),
        Offset(0.07, 0),
        Offset(0.1, 0.025),
  ...
  _MuscleRegion(id: 'triceps', label: 'Triceps', shapes: <_RegionShape>[
    _RegionShape(
      alignment: Alignment(-0.44, -0.23),
      rotationDegrees: 0,
      points: <Offset>[
        Offset(0, 0),
        Offset(0.1, 0),
  ...
  _MuscleRegion(id: 'biceps', label: 'Biceps', shapes: <_RegionShape>[
    _RegionShape(
      alignment: Alignment(-0.405, -0.22),
      rotationDegrees: 0,
      points: <Offset>[
        Offset(0, 0),
        Offset(-0.03, 0.12),
